 ...
 *
 * Using Player#NAME_COMPARATOR is not an alternative. The Java Collections
 ...
 * behave 'strangely'".
 */
public final class PlayerToBeMatched implements PlayerInterface, Comparable<PlayerToBeMatched>, java.io.Serializable {

    /** Generated by the serialver utility */
    //private static final long serialVersionUID = 5678776761419615369L;

    private final PlayerInterface player;

    public PlayerToBeMatched(final PlayerInterface player) {
    ...
    @Override
    public final PlayerInterface getRealPlayer() {
    ...
    public static final void main(final String... args) {
        ...
        final Player kenji_1 = new Player("Kenji", 321, 123);
        final Player kenji_2 = new Player("Kenji", 432, 234);
        final Player kenji_3 = new Player("kenji", 321, 123);
